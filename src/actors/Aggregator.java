...
//            else{
    ...
    //                // Another approach-end
                	System.err.println("\tUnsuccessful aggregation: " + disseminator.getNetworkAddress() + " ->>> ");
                    outcome=AggregationOutcome.UNSUCCESSFUL;
                    ack=false;
                }
//            }
            ...
            // WE SHOULD COME HERE ONLY ONCE - IN THE BEGINING
            AMSAddition=newState;
            this.addDMAMembership(disseminator);
            this.addSMAMembership(newState);
            /*
            *   PROBLEM!!!!
            *   new state should be added only if we really add DMA and SMA memberships! - otherwise it's doubled for no reason
            */
